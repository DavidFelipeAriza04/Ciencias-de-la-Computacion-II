...
def menu_obtener_producto(item_buscar, productos, key):
    ...
    if op_busqueda == 1:
        producto, tiempo = obtener_producto(item_buscar, busqueda_binaria, productos, key)
    elif op_busqueda == 2:
        producto, tiempo = obtener_producto(item_buscar, busqueda_secuencial, productos, key)
    else:
        print("Opción inválida")
        return

    print(imprimir_producto(producto) if producto else "No encontrado")
